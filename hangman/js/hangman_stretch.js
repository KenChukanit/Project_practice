...
function checkGameWon(){
    if(word_status === answer){
        ...
        keyboard.className = "text-result";
        keyboard.innerText = "You Won";
        textHint.innerText = ''
        victorySound().play();
...
function reset(){
    ...
    let keyboard = document.getElementById('keyboard')
    let textHint = document.getElementById('text-hint')
    keyboard.className = "row mb-5"
    textHint.innerText = "(Hint! Guess The Programming Langauge)"
    chooseProgamming();
    getWord();
